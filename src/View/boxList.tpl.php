...
<div class="container">
    ...
    <div class="list-wrap ">
        ...
        <div class="fl" style="width: 50%;text-align: center;background-color: red">
            <img src="web/images/img1.jpg" alt="" width="80%">
    ...
    <div class="look-more news-more fl" style="height: 40px;line-height: 40px;background-color: yellow">
        点击更多
    </div>
    <!-- end 列表-->
    <!-- footer-->
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    html += '<li class="cell fixed newsbox" style="text-align: center;width: 50%;">';
