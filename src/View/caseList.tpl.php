...
<div class="container">
    ...
    <div class="list-wrap list-case-wrap">
        ...
        foreach ($data as $value) {
            ...
            <a href="index.php?c=index&a=newsDetail&id=<?php echo $value['id'] ?>&catid=10" class="newsbox">
        ...
        <div class="last"></div>
        <a href="javascript:;">
            <div class="look-more bg-white news-more">
                点击更多
            </div>
        </a>
    </div>
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    html += '<a class="newsbox" href="index.php?c=index&a=newsDetail&id='+data[i].id+'&catid=10">';
