                ...
                <div class="range bg-white">
                    ...
                    <div class="txt">
                        ...
                        <ul class="mui-flex">
                            ...
                            <li class="cell">
                                <a href="index.php?c=index&a=goods">
                                   <div>
...
<!--            订单跟踪-->
            <div class="swiper-slide">
                ...
                <!-- 列表-->
                <div style="padding-bottom:100px;background:#fff;">
                    <div class="order-track">
                        <div class="sear">
                            <form action="" method="">
                                <input type="text" name="" value="" class="search-input"/>
                                <input type="submit" name="" value="查询" class="search-btn"/>
                            </form>
                        </div>
                        <div class="order-no">
                            <label class="tip">订单号：</label>
                            <label class="no">7849823741874901273</label>
                            <label class="status">运输中</label>
                        </div>
                        <div class="message">
                            <ul>
                                <li>
                                    <label class="time">时间</label>
                                    <label class="pla">状态</label>
                                </li>
                                <li>
                                    <label class="time">2016-02-01 15:20:15</label>
                                    <label class="pla">到达石家庄达</label>
                                </li>
                                <li>
                                    <label class="time">2016-02-01 15:20:15</label>
                                    <label class="pla">到达石家庄</label>
                                </li>
                                <li>
                                    <label class="time">2016-02-01 15:20:15</label>
                                    <label class="pla">到达石家庄</label>
